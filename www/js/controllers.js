...
myApp.controllers = {
          ...
          myApp.services.tasks.create(
            {
              ...
              height: page.querySelector('#height').value,
              description: page.querySelector('#description-input').value,
              waist: page.querySelector('#waist').value,
              shoulder: page.querySelector('#shoulder').value,
              tlength: page.querySelector('#tlength').value,
              hand: page.querySelector('#hand').value,
              back: page.querySelector('#back').value,
              burst: page.querySelector('#burst').value,
  ...
  detailsTaskPage: function(page) {
    ...
    page.querySelector('#height').value = element.data.height;
    page.querySelector('#waist').value = element.data.waist;
    page.querySelector('#shoulder').value = element.data.shoulder;
    page.querySelector('#tlength').value = element.data.tlength;
    page.querySelector('#hand').value = element.data.hand;
    page.querySelector('#burst').value = element.data.burst;
    page.querySelector('#back').value = element.data.back;
            ...
            myApp.services.tasks.update(element,
              {
                ...
                waist: page.querySelector('#waist').value,
                hand: page.querySelector('#hand').value,
                tlength: page.querySelector('#tlength'),
                shoulder: page.querySelector('#shoulder'),
                burst: page.querySelector('#burst'),
                back: page.querySelector('#back'),
